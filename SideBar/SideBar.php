...
if (!isset($_COOKIE["user_id"]) && isset($_SESSION["user_id"])) {
    setcookie("user_id", $_SESSION["user_id"], time() + 180, "/"); // Expires in 3 minutes
    setcookie("user_name", $_SESSION["user_name"], time() + 180, "/"); // Expires in 3 minutes
}

// Check if cookies are set and valid
...
<body>
    ...
    <script>
        ...
        }, 600000); // 60000 milliseconds = 10 minute
    </script>
</body>
</html>
